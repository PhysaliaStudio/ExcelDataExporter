...
namespace Physalia.ExcelDataExporter
{
    internal class TypeDataParser
    {
        private class TypeRawField
        {
            ...
            public TypeRawField(string fieldName, string typeName, string comment)
            {
                _typeName = typeName;
        ...
        private readonly CustomTypeTable _customTypeTable;
        ...
        public TypeData ExportTypeData(SheetRawData sheetRawData)
        {
            ...
            {
                isTypeWithId = metadata.GetSheetType() == SheetType.DataTable,
                namespaceName = metadata.GetNamespace(),
        ...
        private FieldData RecordNewField(TypeRawField nextField)
        {
            ...
            if (fieldTypeName.EndsWith("[]"))  // Expected as array of an system type
            {
                ...
                fieldTypeData = _customTypeTable.GetTypeData(fieldTypeName);
